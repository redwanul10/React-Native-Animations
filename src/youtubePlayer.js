...
import { View, StyleSheet, Text, Dimensions, Image, TouchableOpacity, StatusBar } from 'react-native';
import Animated, {
  useSharedValue,
  useAnimatedStyle,
...
const navigationHeight = Dimensions.get("screen").height - SIZES.height + StatusBar.currentHeight
